...
namespace Quantum.EventSourcing.InMemoryEventStore
{
    public class EventStream
    {
        ...
        private readonly Dictionary<string, ISubscriber> _subscibers;
        ...
        public EventStream(IDateTimeProvider dateTimeProvider)
        {
            ...
            _subscibers = new Dictionary<string, ISubscriber>();
        ...
        private void Append(Event @event)
        {
            ...
            foreach (var s in _subscibers.Values.ToList())
        ...
        internal void MarkAsDeleted() => MetaData.MasrkAsDeleted = true;
        ...
        public void Subscribe(ISubscriber subscriber)
            => _subscibers[subscriber.Name] = (subscriber);
