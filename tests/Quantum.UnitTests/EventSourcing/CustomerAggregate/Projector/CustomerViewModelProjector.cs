...
namespace Quantum.UnitTests.EventSourcing.CustomerAggregate.Projector
{
    public class CustomerViewModelProjector : ImAProjector
    {
        ...
        public CustomerViewModelProjector(QuantumDbContext quantumDbContext)
        {
        ...
        internal void VerifyThatItIsReceivesJustCustomerNameIsChangedEvent(CustomerNameIsChangedEvent nameIsChangedEvent)
        {
            ...
            _receivedEvents.Single().MessageMetadata.CorrelationId.Should().Be(nameIsChangedEvent.MessageMetadata.CorrelationId);
        }
